...
```
That will let your user to not need sudo for using the multinet-exec, thats used for running the command ip as your own user.
That's for keeping the permissions for your desktop environment.
